...
if (brand?.primary) {
  ...
  const varsCss = [
    ...
    `  --muted-color: ${b.siteMuted}; /* Muted grey (dates, locations, footer) */`,
    ...
    '  --on-accent-color: #ffffff; /* Text on primary/accent surfaces */',
    ...
    '/* Dark theme */',
    '[data-theme="dark"] {',
    `  --primary-color: ${b.sitePrimaryDark}; /* Amber (warm, XSLT-aligned) */`,
    `  --secondary-color: ${b.siteSecondaryDark}; /* Orange accent */`,
    `  --third-color: ${b.siteAccentDark}; /* Amber-orange */`,
    `  --body-color: ${b.siteBodyDark}; /* Cream body text */`,
    `  --muted-color: ${b.siteMutedDark}; /* Warm muted (XSLT-aligned --muted) */`,
    `  --emphasis-color: ${b.siteEmphasisDark}; /* Bright cream for emphasis */`,
    `  --background-color: ${b.darkBg}; /* Dark bordeaux-brown */`,
    `  --card-background: ${b.siteCardDark}; /* Raised bordeaux-brown surface */`,
    `  --text-color: ${b.siteEmphasisDark}; /* Cream text */`,
    `  --border-color: ${b.siteBorderDark}; /* Bordeaux-brown rule */`,
    `  --on-accent-color: ${b.darkBg}; /* Dark text on light amber surfaces */`,
