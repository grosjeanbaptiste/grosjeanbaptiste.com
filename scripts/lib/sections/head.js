...
function buildMeta(b, lang, description, ogTitle, imageUrl, t, hardSkills, brand) {
  ...
  return [
    ...
    // ?v=7 cache-buster: Chrome keeps favicons in a separate DB that ignores
    ...
    '<link rel="icon" type="image/svg+xml" href="/assets/icons/favicon.svg?v=7">',
    ...
    '<link rel="apple-touch-icon" sizes="180x180" href="/assets/icons/favicon-180.png?v=7">',
