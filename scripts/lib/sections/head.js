...
function buildMeta(b, lang, description, ogTitle, imageUrl, t, hardSkills, brand) {
  ...
  return [
    ...
    // ?v=16 cache-buster: Chrome keeps favicons in a separate DB that ignores
    ...
    '<link rel="icon" href="/favicon.ico?v=16" sizes="any">',
    '<link rel="icon" type="image/svg+xml" href="/assets/icons/favicon.svg?v=16">',
    '<link rel="icon" type="image/png" sizes="32x32" href="/assets/icons/favicon-32.png?v=16">',
    '<link rel="icon" type="image/png" sizes="16x16" href="/assets/icons/favicon-16.png?v=16">',
    '<link rel="apple-touch-icon" sizes="180x180" href="/assets/icons/favicon-180.png?v=16">',
